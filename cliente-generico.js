...
function CadastroMotorista (nome, cpf, cnh, veiculo, revavam, vencimentoCarteira){
    this.nome = nome;
    this.cpf = cpf;
    this.cnh = cnh;
...
const Motorista1 = new CadastroMotorista (" Marcos ", " 000 000 000 00", "B" , "Caminhão 4 eixos", " 234765456" , 15/10/2022)
const Motorista2 = new CadastroMotorista ("Luiz Carlos" , "111 111 111 11" , " D" , "Carreta" , " 777777777" , 01/02/2023)
const Motorista3 = new CadastroMotorista ( "Juliano" , "222 222 222 22" , "D" ,  "Kombi" , "333333333" , 20/04/2023)
const Motorista4 = new CadastroMotorista ( "Guilherme" , "333 333 333 33" , "444 444 444 44" , 25/05/2025 )
